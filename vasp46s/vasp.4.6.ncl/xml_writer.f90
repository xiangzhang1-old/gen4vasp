...
!-MM- end of addition
      ...
      CALL XML_INCAR('GGA','S',IDUM,RDUM,CDUM,LDUM,SZGGA,2)
      CALL XML_INCAR('VOSKOWN','I',LFCI,RDUM,CDUM,LDUM,CHARAC,1)
      CALL XML_INCAR('LASPH','L',IDUM,RDUM,CDUM,LASPH,CHARAC,1)
      CALL XML_INCAR('LMETAGGA','L',IDUM,RDUM,CDUM,LMETAGGA,CHARAC,1)
      CALL XML_INCAR('GGA2','S',IDUM,RDUM,CDUM,LDUM,SZGGA2,1)
      CALL XML_CLOSE_TAG
      ...
      CALL XML_INCAR('IDIPOL','I',IDIPCO,RDUM,CDUM,LDUM,CHARAC,1)
      CALL XML_INCAR('LDIPOL','L',IDUM,RDUM,CDUM,LCOR_DIP,CHARAC,1)
      CALL XML_INCAR_V('DIPOL','F',IDUM,POSCEN,CDUM,LDUM,CHARAC,1)
      ...
      CALL XML_INCAR('LCRITICAL_MEM','L',IDUM,RDUM,CDUM,LCRITICAL_MEM,CHARAC,1)
