...
!**********************************************************************
      ...
      SUBROUTINE OVERLAP_AE(R,ITYP,NTYP,LNMAX,WAE,L_OF_LN)
...
!**********************************************************************
      ...
      IF (PRINTOCC>1) THEN
         ...
         WRITE(*,*) 'component',ISP
         DO LMN1=19,32
            WRITE(*,'(14F12.6)') (REAL(POT_U(LMN1,LMN2,ISP)),LMN2=19,32)
         ENDDO
         WRITE(*,*)
         DO LMN1=19,32
            WRITE(*,'(14F12.6)') (AIMAG(POT_U(LMN1,LMN2,ISP)),LMN2=19,32)
         ENDDO
         WRITE(*,*)
         ENDDO
...
!-----------------------------------------------------------------------
      ...
      DO M1=1,2*L1+1
         ...
         DO M2=1,2*L2+1
            ...
            DO ISP=1,NCDIJ                                                       
               TMP= -1._q*(U(ITYP)-J(ITYP))*OCC_MAT(LM2,LM1,ISP)
               ...
               DC=DC+POT_U(LMN1,LMN2,ISP)*CONJG(CRHODE(LMN2,LMN1,ISP))
         ...
         DO M2=1,2*L2+1
            ...
            DO ISP=1,NCDIJ,NCDIJ-1                                                       
               IF (L1==L2.AND.M1==M2) THEN
                  POT_U(LMN1,LMN2,ISP) = -1._q*U(ITYP)*OVERLAP_AE_(LN1,LN2,ITYP)
                  ! energy correction 
