...
!
!  optimize Real-space projektionsoperatoren according to
...
!    get the right boundary condition for BETA (brute force is simplest)
      QR=DELR/100
      SUM=0
      DO K=1,MJ
         CALL SBESSE2(QR*QX(K), BJ , BJP, LL(I))
      ...
      IF (LCSTR) THEN
         CALL SPLCOF_N0(BETA(1,1,I) ,NQNL,NQNL,(SUM-BETA(1,2,I))/QR)
      ELSE
         CALL SPLCOF(BETA(1,1,I) ,NQNL,NQNL,(SUM-BETA(1,2,I))/QR)
      ENDIF
...
!
      DO 50 I=1,N-1
        ...
        P(5,I)=R/S
        P(4,I)=P(4,I)/2.0_q
   50   P(3,I)=(P(2,I+1)-P(2,I))/S-(P(4,I)+R)*S
      RETURN
      END
