      ...
      CONTAINS
        ...
        ! check whether maxstringlen is sufficiently large
          ...
          IF (PRESENT(name)) THEN
             WRITE(uixml, '(" name=""",A,""" ")',ADVANCE="No") name
          ENDIF
          IF (PRESENT(type).AND.type/="float") THEN
             WRITE(uixml, '(" type=""",A,""" ")',ADVANCE="No") type
          ENDIF
          IF (PRESENT(param)) THEN
             WRITE(uixml, '(" param=""",A,"""")',ADVANCE="No")  param
          ENDIF
          IF (PRESENT(comment)) THEN
             WRITE(uixml, '(" comment=""",A,"""")',ADVANCE="No")  comment
          ENDIF
...
!=======================================================================
        ...
        SUBROUTINE XML_TAG_STRING( tag, string)
          ...
          IF (lxml) WRITE(uixml, '(A,"<i name=""",A,""" type=""string"">",A,"</i>")')  blank(1:inden),tag,string
        ...
        SUBROUTINE XML_TAG_REAL( tag, r)
          ...
          IF (lxml) WRITE(uixml, '(A,"<i name=""",A,""">",F16.8,"</i>")')  blank(1:inden),tag,r
        ...
        SUBROUTINE XML_TAG_INT( tag, i)
          ...
          IF (lxml) WRITE(uixml, '(A,"<i name=""",A,""" type=""int"">",I8,"</i>")')  blank(1:inden),tag,i
...
!=======================================================================
        ...
        SUBROUTINE XML_VEC_REAL( v, name, form)
          ...
          IF (PRESENT(name)) THEN
             WRITE(uixml, '(A,"<v name=""",A,""">")',ADVANCE="No")  blank(1:inden),name
          ELSE
        ...
        SUBROUTINE XML_VEC_INT( v, name, form)
          ...
          IF (PRESENT(name)) THEN
             WRITE(uixml, '(A,"<v type=""int"" name=""",A,""">")',ADVANCE="No")  blank(1:inden),name
          ELSE
             WRITE(uixml, '(A,"<v type=""int"" > ")',ADVANCE="No") blank(1:inden)
          ENDIF
          DO i=1,size(v)
             WRITE(uixml,f,ADVANCE="No") v(i)
          ENDDO
        ...
        SUBROUTINE XML_VEC_LOG( v, name)
          ...
          IF (.NOT. lxml) RETURN
          IF (PRESENT(name)) THEN
             WRITE(uixml, '(A,"<v type=""logical"" name=""",A,""">")',ADVANCE="No")  blank(1:inden),name
          ELSE
             WRITE(uixml, '(A,"<v type=""logical"" > ")',ADVANCE="No") blank(1:inden)
          ENDIF
          DO i=1,size(v)
...
!=======================================================================
        ...
        SUBROUTINE XML_TIMING( time1, time2, name )
          ...
          IF (PRESENT(name)) THEN
             WRITE(uixml, '(A,"<time name=""",A,""">")',ADVANCE="No")  blank(1:inden),name
          ELSE
...
!=======================================================================
        ...
        SUBROUTINE XML_FIELD( name, type, unit)
          ...
          IF (PRESENT(unit)) THEN
             WRITE(uixml, '(" unit=""",A,"""")',ADVANCE="No")  unit
          ENDIF
...
!=======================================================================
        ...
        SUBROUTINE XML_DIMENSION(name, dim)
          ...
          WRITE(uixml, '(" dim=""",A,"""")',ADVANCE="No") TRIM(ADJUSTL(strcounter))
          WRITE(uixml, '(">")',ADVANCE="No")
...
! local variables
        ...
        SELECT CASE (FORM)
           CASE ("S")
              i=LEN_TRIM(str)
              WRITE(uixml, '(A,"<",A,">",A,"</",A,">")',ADVANCE="Yes")  blank(1:inden),tag,str(1:i),tag
           CASE("I")
              WRITE(uixml, '(A,"<",A,">")',ADVANCE="No")   blank(1:inden),tag
              DO i=1,N
                 WRITE(uixml,'(I6)',ADVANCE="No") INTRES(i)
              ENDDO
              WRITE(uixml, '("</",A,">")',ADVANCE="Yes")  tag
           CASE("F")
              WRITE(uixml, '(A,"<",A,">")',ADVANCE="No")   blank(1:inden),tag
              DO i=1,N
...
! local variables
        ...
        SELECT CASE (FORM)
           CASE ("S")
              i=LEN_TRIM(str)
              WRITE(uixml, '(A,"<i type=""string"" name=""",A,""">",A,"</i>")',ADVANCE="Yes")  blank(1:inden),tag,str(1:i)
           CASE("I")
              WRITE(uixml, '(A,"<i type=""int"" name=""",A,""">")',ADVANCE="No")   blank(1:inden),tag
              DO i=1,N
                 WRITE(uixml,'(I6)',ADVANCE="No") INTRES(i)
              ENDDO
              WRITE(uixml, '("</i>")',ADVANCE="Yes") 
           CASE("F")
              WRITE(uixml, '(A,"<i name=""",A,""">")',ADVANCE="No")   blank(1:inden),tag
              DO i=1,N
                 WRITE(uixml,'(F16.8)',ADVANCE="No") FLTRES(i)
              ENDDO
              WRITE(uixml, '("</i>")',ADVANCE="Yes") 
           CASE("C")
              WRITE(uixml, '(A,"<i type=""complex"" name=""",A,""">")',ADVANCE="No")   blank(1:inden),tag
              DO i=1,N
                 WRITE(uixml,'(2F16.8,2X)',ADVANCE="No") CMPRES(i)
              ENDDO
              WRITE(uixml, '("</i>")',ADVANCE="Yes") 
           CASE("L")
              WRITE(uixml, '(A,"<i type=""logical"" name=""",A,""">")',ADVANCE="No")   blank(1:inden),tag
              DO i=1,N
                 WRITE(uixml,'(L2,2X)',ADVANCE="No") LOGRES(i)
              ENDDO
              WRITE(uixml, '("</i>")',ADVANCE="Yes") 
...
! local variables
        ...
        SELECT CASE (FORM)
           CASE ("S")
              i=LEN_TRIM(str)
              WRITE(uixml, '(A,"<v type=""string"" name=""",A,""">",A,"</v>")',ADVANCE="Yes")  blank(1:inden),tag,str(1:i)
           CASE("I")
              WRITE(uixml, '(A,"<v type=""int"" name=""",A,""">")',ADVANCE="No")   blank(1:inden),tag
              DO i=1,N
                 WRITE(uixml,'(I6)',ADVANCE="No") INTRES(i)
           ...
           CASE("F")
              WRITE(uixml, '(A,"<v name=""",A,""">")',ADVANCE="No")   blank(1:inden),tag
              DO i=1,N
                 WRITE(uixml,'(F16.8)',ADVANCE="No") FLTRES(i)
                 IF (MOD(i,break)==0) WRITE(uixml,*)
              ENDDO
              WRITE(uixml, '("</v>")',ADVANCE="Yes") 
           CASE("C")
              WRITE(uixml, '(A,"<v type=""complex"" name=""",A,""">")',ADVANCE="No")   blank(1:inden),tag
              DO i=1,N
                 WRITE(uixml,'(2F16.8,2X)',ADVANCE="No") CMPRES(i)
                 IF (MOD(i,break)==0) WRITE(uixml,*)
              ENDDO
              WRITE(uixml, '("</v>")',ADVANCE="Yes") 
           CASE("L")
              WRITE(uixml, '(A,"<v type=""logical"" name=""",A,""">")',ADVANCE="No")   blank(1:inden),tag
              DO i=1,N
                 WRITE(uixml,'(L2,2X)',ADVANCE="No") LOGRES(i)
                 IF (MOD(i,break)==0) WRITE(uixml,*)
              ENDDO
        ...
        DO i=1,ISPIN
           ...
           DO nk=1,NKPTS
              ...
              DO n=1,NB_TOT
                 TMP(1)=CELTOT(n,nk,i)
                 TMP(2)=FERTOT(n,nk,i)
                 CALL XML_ROW_DATA(TMP, FORM='(F8.4)')
              ENDDO
      ...
      ! local
        ...
        DO isp=1,ISPIN
           ...
           DO n=1,nedos
              ...
              CALL XML_ROW_DATA( tmp(1:3),form='(F8.4,1X)')
           ENDDO
           CALL XML_CLOSE_TAG("set")
        ENDDO
           ...
           DO ni=1,NIONS
              ...
              DO isp=1,ISPIN
                 ...
                 DO n=1,nedos
                    ...
                    CALL XML_ROW_DATA( tmp(1:lmax+1), form='(F8.4,1X)')
                 ENDDO
                 CALL XML_CLOSE_TAG("set")
              ENDDO
              CALL XML_CLOSE_TAG("set")
...
!=======================================================================
     ...
     ! local
        ...
        CALL XML_EIGENVALUES(CELTOT, FERTOT, NB_TOT, NKPTS, ISPIN)
        ...
        DO l=1,LDIM
           CALL SPHPRO_DESCRIPTION(0, l, lmtype)
           IF (lmtype=="   ") THEN
              EXIT
           ENDIF
           CALL SPHPRO_DESCRIPTION(0, l, lmtype)
           IF (lmtype=="err") THEN
              WRITE(0,*) 'internal error: SPHPRO_DESCRIPTION returns an error for NI=',0,' L',L
              STOP
              EXIT
           ENDIF
